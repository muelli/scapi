 ...
 */
public class ScPrpFromPrfVarying extends PrpFromPrfVarying {
	
	public ScPrpFromPrfVarying(String prfVaringIOLengthName) {
	...
	public void computeBlock(byte[] inBytes, int inOff, int inLen, byte[] outBytes, int outOff, int outLen) throws IllegalBlockSizeException {
		...
		for(int i=1; i<=4; i++){
			...
			prfVaryingIOLength.computeBlock(rightCurrent, 0, rightCurrent.length, rightNext, 0, inLen);
	...
	public String getAlgorithmName() {
		...
		return "SC_PRP_FROM_PRP_VARYING";
	}
