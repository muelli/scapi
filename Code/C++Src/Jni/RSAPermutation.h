...
#include <jni.h>
/* Header for class edu_biu_scapi_primitives_trapdoor_permutation_cryptopp_CryptoPpRSAPermutation */

#ifndef _Included_edu_biu_scapi_primitives_trapdoor_permutation_cryptopp_CryptoPpRSAPermutation
#define _Included_edu_biu_scapi_primitives_trapdoor_permutation_cryptopp_CryptoPpRSAPermutation
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_edu_biu_scapi_primitives_trapdoor_1permutation_cryptopp_CryptoPpRSAPermutation_deleteRSA
  (JNIEnv *, jobject, jlong);
