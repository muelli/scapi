...
#include <jni.h>
/* Header for class edu_biu_scapi_primitives_trapdoor_permutation_cryptopp_CryptoPpRabinPermutation */

#ifndef _Included_edu_biu_scapi_primitives_trapdoor_permutation_cryptopp_CryptoPpRabinPermutation
#define _Included_edu_biu_scapi_primitives_trapdoor_permutation_cryptopp_CryptoPpRabinPermutation
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_edu_biu_scapi_primitives_trapdoor_1permutation_cryptopp_CryptoPpRabinPermutation_deleteRabin
  (JNIEnv *, jobject, jlong);
