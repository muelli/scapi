...
public class DlogECFpTest extends DlogECTest{
	...
	public DlogECFpTest(DlogGroup dlog){
		super(dlog);
		try { 
			Class<? extends DlogGroup> dlogClass = dlog.getClass();
			Constructor<? extends DlogGroup> constructor = dlogClass.getConstructor(String.class);
			DlogGroup dlogGroup = (DlogGroup) constructor.newInstance("P-192");
			...
			addData(dlogGroup, exponent, xElementA, yElementA, xExpectedOutput, yExpectedOutput);
			...
			addData(dlogGroup, x, xElementB, yElementB, xExpectedOutput, yExpectedOutput);
			
			//224-bit Random ECP Group
			DlogGroup dlogGroup1 = (DlogGroup) constructor.newInstance("P-224");
			...
			addData(dlogGroup1, y1, xElementA1, yElementA1, xOutput1, yOutput1);
			...
			addData(dlogGroup1, x1, xElementB1, yElementB1, xOutput1, yOutput1);
			
			//256-bit Random ECP Group
			DlogGroup dlogGroup2 = (DlogGroup) constructor.newInstance("P-256");
			...
			addData(dlogGroup2, y2, xElementA2, yElementA2, xOutput2, yOutput2);
			...
			addData(dlogGroup2, x2, xElementB2, yElementB2, xOutput2, yOutput2);
			
			//384-bit Random ECP Group
			DlogGroup dlogGroup3 = (DlogGroup) constructor.newInstance("P-384");
			...
			addData(dlogGroup3, y3, xElementA3, yElementA3, xOutput3, yOutput3);
			...
			addData(dlogGroup3, x3, xElementB3, yElementB3, xOutput3, yOutput3);
			
			
			//521-bit Random ECP Group
			DlogGroup dlogGroup4 = (DlogGroup) constructor.newInstance("P-521");
			...
			addData(dlogGroup4, y4, xElementA4, yElementA4, xOutput4, yOutput4);
			...
			addData(dlogGroup4, x4, xElementB4, yElementB4, xOutput4, yOutput4);
