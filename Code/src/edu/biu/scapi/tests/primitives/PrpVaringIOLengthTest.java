...
import edu.biu.scapi.primitives.crypto.prf.PrpVaryingIOLength;
 ...
 */
public class PrpVaringIOLengthTest extends PrfTest {
	
	/**
	 * 
	 */
	public PrpVaringIOLengthTest(PrpVaryingIOLength prpVaryingIOLength) {
